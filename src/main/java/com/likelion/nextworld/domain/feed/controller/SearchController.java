...
import com.likelion.nextworld.domain.feed.service.SearchService;
  ...
  @Operation(
      ...
      description =
          """
              ...
              """)
  @GetMapping
  public ResponseEntity<BaseResponse<ListResponse>> search(
      @RequestParam("keyword") String keyword) {

    ListResponse result = searchService.search(keyword);
